...
class HoldingCurrent(Base):
    ...
    portfolio_id = Column(UUID(as_uuid=True), ForeignKey('portfolios.portfolio_id', ondelete='CASCADE'), nullable=False)
    ticker_id = Column(UUID(as_uuid=True), ForeignKey('tickers.ticker_id', ondelete='RESTRICT'), nullable=False)
...
class PriceDaily(Base):
    ...
    ticker_id = Column(UUID(as_uuid=True), ForeignKey('tickers.ticker_id', ondelete='CASCADE'), nullable=False, primary_key=True)
